...
live0.visible=false;
 ...
 heart1=createSprite(x,50);
  heart2=createSprite(x+60,50);
  heart3=createSprite(x+120,50);
  heart1.scale=0.65;
  heart2.scale=0.65;
  heart3.scale=0.65;
